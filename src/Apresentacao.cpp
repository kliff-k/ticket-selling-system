...
void CntrAluno::editar() {
    ...
    Aluno alunoRecuperado = comandoA.getResultado();

    cout << endl << "Dados atuais." << endl << endl;
    cout << "Nome : " << alunoRecuperado.getNome().getValor() << endl;
    cout << "Matricula : " << alunoRecuperado.getMatricula().getValor() << endl;
    cout << "Senha : " << alunoRecuperado.getSenha().getValor() << endl;
    cout << "Matricula do orientador : " << alunoRecuperado.getMatriculaOrientador().getValor() << endl << endl;
