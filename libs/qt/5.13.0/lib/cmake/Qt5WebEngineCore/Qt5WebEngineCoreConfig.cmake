...
set(Qt5WebEngineCore_VERSION_STRING 5.13.0)
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(_Qt5WebEngineCore_OWN_INCLUDE_DIRS
      "${_qt5WebEngineCore_install_prefix}/lib/QtWebEngineCore.framework"
      "${_qt5WebEngineCore_install_prefix}/lib/QtWebEngineCore.framework/Headers"
    )
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/lib/QtWebEngineCore.framework/Versions/5/Headers/5.13.0/"
        "${_qt5WebEngineCore_install_prefix}/lib/QtWebEngineCore.framework/Versions/5/Headers/5.13.0/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WebEngineCore PROPERTY FRAMEWORK 1)
    ...
    _populate_WebEngineCore_target_properties(RELEASE "QtWebEngineCore.framework/QtWebEngineCore" "" )
